...
<body>
        ...
        <div class="header">
            <a href="home.html"><img src="images/WhiteIcon.png" alt="logo" class="HomeIcon"></a>
            <a href="home.html">作伙</a>
        </div>

        <div class="container">
            <div align="center" style="margin-bottom: 18px;">
                <img src="images/BrownIcon.png" alt="logo" class="HomeIcon">
                <span style="font-size:22px; font-weight:bold; color:rgb(126, 83, 2, 0.75)"> | 登入尋找喜歡的房！</span>
            </div>
